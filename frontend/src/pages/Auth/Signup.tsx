...
const Signup: React.FC<SignupProps> = ({ setToken }) => {
  ...
  // ============================================================
  // 🔕 REMOVED: OTP step state (commented out for later)
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ============================================================
      // 🔕 OLD: Move to OTP step (commented out)
      // ============================================================
      // setStep('otp');
      // if (data.devOtp) {
  ...
  // ============================================================
  // 🔕 REMOVED: handleVerifyOtp (commented out for later)
  // ============================================================
  /*
...
// ============================================================
// 🔕 OLD CODE WITH OTP VERIFICATION (commented out for later)
// ============================================================
/*
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
